...
const NewsLetter = () => {
  return (
    ...
    lg:mx-auto my-30 bg-gray-900 text-white">
        <Title title="Hotel Booking" subTitle='join our newsletter and be ths first to
        discover new destinations, exclusive offers, and travel inspiration.'/>
            ...
            <p className="text-gray-500 mt-6 text-xs text-center">By subscribing, you agree 
                to our Privacy Policy and consent to receive updates.</p>
    </div>
  )
}

      ...
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
          ...
          <div className="grid grid-cols-2 gap-4 lg:w-1/2 w-full">
            {room?.images.length > 1 &&
              room.images.map((image, index) => (
                <img onClick={() => setMainImage(image)} key={index}  src={image}
                  alt="Room thumbnail"  className={`w-full rounded-xl shadow-xl object-cover cursor-pointer ${
        ...
        >
          <div className="flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500">
            <div className="flex flex-col">
              ...
              <input  type="date"  id="checkInDate"  className="w-full rounded border border-gray-300 px-3 py-2 mt-1.5 outline-none"
                required/>
            </div>
            ...
            <div className="flex flex-col">
              ...
              <input  type="date"  id="checkOutDate"  className="w-full rounded border border-gray-300 px-3 py-2 mt-1.5 outline-none"
                required/>
            </div>
          ...
          <button  type="submit"  className="bg-primary hover:bg-primary-dull active:scale-95 transition-all 
           text-white rounded-md max-md:w-full max-md:mt-6 md:px-6 py-3 md:py-4 text-base cursor-pointer">
            Check Availability
          </button>
        </form>
        ...
        <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
            <p>Guest will be allocated on the ground floor according to availability.
                you get a comfortable Two bedroom apartemdnt has a true city feeling. The
        ...
        hover:bg-primary-dull trasition-all cursor-pointer'>Contact Now</button>
      </div>
    )
  )
}
